...
urlpatterns = [
    ...
    path(
        "<id>/fianaleditcashmemo", views.fianaleditcashmemo, name="fianaleditcashmemo"
    ),
    ...
    path(
        "<id>/mrfianaleditcashmemo",
        views.mrfianaleditcashmemo,
    ...
    path("corporatepaylist", views.corporatepay, name="corporatepaylist"),
    ...
    path(
        ...
        paybillcatogoryAutocompleteview.as_view(),
        name="paybillcatogoryAutocomplete",
    ),
    path(
        "paybillcatogory-autocomplete/",
        PayBillCategoryAutocomplete.as_view(),
        name="paybillcatogory-autocomplete",
    ),
    path("productcreate", views.product_create, name="product_create"),
    path(
        "autocomplete-groupnamecopy/",
        views.autocomplete_groupnamecopy,
        name="autocomplete-groupnamecopy",
    ),
    path(
        "autocomplete_category/",
        views.autocomplete_category,
    ...
    path(
        "paybillcategorycreate",
        views.paybillcategory_create_view,
        name="paybillcategory_create",
    ),
    path(
        "corpocategorycreate",
        views.corpocategory_create_view,
        name="corpocategory_create",
    ),
    ...
    path(
        "soldreportgroup",
        views.product_list_grouped_by_category,
        name="product_list_grouped",
    ),
    path("menu", views.menu_view, name="menu"),
    path("dashboard", views.sales_dashboard, name="sales_dashboard"),
    path("<id>/corportepayedit",views.corpo, name="corportepayedit")
]
